...
public class StaticKwd_intro {
	 ...
	 * -> variables
	 * -> static block
	 * -> static inner class - not used !
	 * 
	 * Static keyword means ,static variable, method etc belongs to class itself not to the object .
	 * inside the class we call Static stuff directly, outside of the class we call className.method /className.variable
	...
	//static variable increased in eact time object creating
	...
	public static void staticMethod() {
		...
		st.age = 25;   // --> invoked non static variable
		st.nonStatic();  // --> invoked non static method.
	}
