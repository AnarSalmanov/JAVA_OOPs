...
public class Interface_intro {
     ...
     *  Interface can have another sub Interface. Interface extends another Interface
     ...
     *  one or more Interfaces, then class first extends then implements to Interface
     *  That class must override all abstract methods of Abstract class and Interface.
     ...
     *  Can't be private and final.(Otherwise other classes can't implement).
     *
     *
     *
     *                             INTERFACE VARIABLES
     *  Interface can have only constant variables (public static final int VAR)
