...
public class Inheritance_intro {
     ...
     * also we use implements keyword to inherit from Parent interfaces.
     ...
     * Can access to any type of access modifiers except private members.
     ...
     * If Child and Parent are in different package,n Child is visible public and protected.
     * Constructor not inherited from Parent class.( not visible from child class)
     * Private variables and methods are not visible in Child class!
     *
